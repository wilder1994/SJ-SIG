...
Route::middleware(['auth', 'user.active', 'password.changed', 'contract.bound', 'contract.required', 'tech.modules'])->group(function (): void {
    ...
    Route::get('/personal/{person}/editar', [PersonController::class, 'edit'])->name('people.edit');
    ...
    Route::post('/documentos/carpeta/{person}/lote', [DocumentController::class, 'storeBatch'])->name('documents.batch.create');
    Route::get('/documentos/carpeta/{person}/lote/{batch}', [DocumentController::class, 'batchIndex'])->name('documents.batch.index');
    Route::get('/documentos/carpeta/{person}/lote/{batch}/ver', [DocumentController::class, 'previewBatch'])->name('documents.batch.preview');
    Route::post('/documentos/carpeta/{person}/lote/{batch}', [DocumentController::class, 'storeBatchIndex'])->name('documents.batch.store');
