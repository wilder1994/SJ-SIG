...
| **Documentos** | Carpeta por vigilante. HV (26), Contratación (9), Certificados (3), Cursos y capacitación (25+otro), Afiliaciones (8) y Otros (hasta 20, tipo libre) indexadas | Interno/admin: un PDF + indexar (carpeta/tipo por corte); entidad consulta Listado/ojo |
